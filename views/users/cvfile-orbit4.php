<html lang="en" class="fontawesome-i2svg-active fontawesome-i2svg-complete"><head>
    ...
    <link id="theme-style" rel="stylesheet" href="../../public/css/orbit-4.css">
    ...
    <div class="wrapper">
        <div class="sidebar-wrapper">
            ...
            <div class="education-container container-block">
                ...
                <div class="item">
                    <h4 class="degree">Đại học KT-CN Cần Thơ</h4>
                    <h5 class="meta">Tốt nghiệp loại Giỏi, điểm trung bình 8.4</h5>
        ...
        <div class="main-wrapper">
            ...
            <section class="section experiences-section">
                ...
                <div class="item">
                    <div class="meta">
                        <div class="upper-row">
                            <h3 class="job-title">Đồ án Kỹ thuật phần mềm 1</h3>
                ...
                <div class="item">
                    <div class="meta">
                        <div class="upper-row">
                            <h3 class="job-title">Đồ án Kỹ thuật phần mềm 2</h3>
                ...
                <div class="item">
                    <div class="meta">
                        <div class="upper-row">
                            <h3 class="job-title">Đồ án Kỹ thuật phần mềm 3</h3>
            ...
            <section class="section experiences-section">
                ...
                <div class="item">
                    <div class="meta">
                        <div class="upper-row">
                            <h3 class="job-title">Nhóm tình nguyện hè</h3>
                            <div class="time">Hè 2015</div>
                        </div><!--//upper-row-->
                    </div><!--//meta-->
                    <div class="details">
                        <p>Tham gia chiến dịch Mùa Hè Xanh</p>
                    </div><!--//details-->
                </div><!--//item-->
                <div class="item">
                    <div class="meta">
            ...
            <section class="section experiences-section">
                ...
                <div class="item">
                    <div class="meta">
                        <div class="upper-row">
                            <h3 class="job-title">Chứng chỉ tin học căn bản</h3>
            ...
            <section class="section experiences-section">
                ...
                <div class="item">
                    <div class="meta">
                        <div class="upper-row">
                            <h3 class="job-title">Học bổng học tập (loại giỏi)</h3>
                            <div class="time">2016</div>
                        </div><!--//upper-row-->
            ...
            <section class="section projects-section">
                ...
                <div class="item">
                    <div class="meta">
                        <div class="upper-row">
                            <h3 class="job-title">Rainway group</h3>
