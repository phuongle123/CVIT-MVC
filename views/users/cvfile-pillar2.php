<html lang="en" class="fontawesome-i2svg-active fontawesome-i2svg-complete"><head>
	...
	<!-- Theme CSS -->  
	<link id="theme-style" rel="stylesheet" href="../../public/css/pillar-2.css">
			...
			<div class="resume-body p-5">
				<section class="resume-section summary-section mb-5">
					...
					<div class="resume-section-content">
						<p class="mb-0">Tôi là một chuyên gia tự do hoàn toàn tự do Sáng tạo Giao diện người dùng Nhà thiết kế và Nhà phát triển Liên quan với thiết kế web mới nhất và công nghệ là tuyệt vời cảm thấy liên lạc với sáng tạo</p>
					</div>
					...
					<div class="col-lg-9">
							...
							<div class="resume-section-content">
								<div class="resume-timeline position-relative">
									<article class="resume-timeline-item position-relative pb-5">
										<div class="resume-timeline-item-header mb-2">
											<div class="d-flex flex-column flex-md-row">
												<h3 class="resume-position-title font-weight-bold mb-1">Đồ án Kỹ thuật phần mềm 1
												</h3>
											</div><!--//row-->
											<div class="resume-position-time">2016</div>
										</div><!--//resume-timeline-item-header-->
										<div class="resume-timeline-item-desc">
											<p>Tìm hiểu công nghệ Ajax, MongoBD</p>
										</div><!--//resume-timeline-item-desc-->
									</article>
									<article class="resume-timeline-item position-relative pb-5">
										<div class="resume-timeline-item-header mb-2">
											<div class="d-flex flex-column flex-md-row">
												<h3 class="resume-position-title font-weight-bold mb-1">Đồ án Kỹ thuật phần mềm 2
												</h3>
											</div><!--//row-->
									...
									<article class="resume-timeline-item position-relative pb-5">
										<div class="resume-timeline-item-header mb-2">
											<div class="d-flex flex-column flex-md-row">
												<h3 class="resume-position-title font-weight-bold mb-1">Đồ án Kỹ thuật phần mềm 3
												</h3>
											</div><!--//row-->
						...
						<section class="resume-section experience-section mb-5">
							...
							<div class="resume-section-content">
								<div class="resume-timeline position-relative">
									<article class="resume-timeline-item position-relative pb-5">
										...
										<div class="resume-timeline-item-header mb-2">
											<div class="d-flex flex-column flex-md-row">
												<h3 class="resume-position-title font-weight-bold mb-1">Nhóm tình nguyện hè
												</h3>								       
											</div><!--//row-->
											<div class="resume-position-time">Hè 2015</div>
										</div><!--//resume-timeline-item-header-->
										<div class="resume-timeline-item-desc">
											<p>Tham gia chiến dịch Mùa Hè Xanh
											</p>
										</div><!--//resume-timeline-item-desc-->
									</article>
									<article class="resume-timeline-item position-relative pb-5">
										<div class="resume-timeline-item-header mb-2">
											...
											<div class="resume-position-time">Hè 2016</div>
										</div><!--//resume-timeline-item-header-->
										<div class="resume-timeline-item-desc">
											<p>Tham gia chiến dịch Mùa Hè Xanh
											</p>
							...
							<div class="resume-timeline-item-header mb-4">
								<div class="d-flex flex-column flex-md-row">
									<h3 class="resume-position-title font-weight-bold mb-1">Rainway group</h3>										        
								</div><!--//row-->
							...
							<div class="resume-section-content">
								<div class="resume-timeline position-relative">
									<article class="resume-timeline-item position-relative pb-5">
										...
										<div class="resume-timeline-item-desc">
											<p>Ứng dụng mobile giúp mọi người đặt vé nhanh chóng bất kì lúc nào, bất kì nơi đâu.
											</p>									        
										</div><!--//resume-timeline-item-desc-->
									</article>
									<article class="resume-timeline-item position-relative pb-5">
									...
									<article class="resume-timeline-item position-relative pb-5">
										...
										<div class="resume-timeline-item-desc">
											<p>- Phân tích và thiết kế hệ thống, phát triển module, tối ưu code, sửa lỗi
											</p>									        
										</div><!--//resume-timeline-item-desc-->
									</article>
									<article class="resume-timeline-item position-relative pb-5">
										...
										<div class="resume-timeline-item-desc">
											<p>- Android Studio 1.4, Java, Android 4.0; Google Could Message
											</p>									        
										</div><!--//resume-timeline-item-desc-->
									</article>
								</div><!--//resume-timeline-->
					...
					<div class="col-lg-3">
						<section class="resume-section skills-section mb-5">
							...
							<div class="resume-section-content">
								<div class="resume-skill-item">
									<h4 class="resume-skills-cat font-weight-bold">HTML</h4>
									<h4 class="resume-skills-cat font-weight-bold">CSS</h4>
									<h4 class="resume-skills-cat font-weight-bold">PHP</h4>
									<h4 class="resume-skills-cat font-weight-bold">JQUERY</h4>
									<h4 class="resume-skills-cat font-weight-bold">JAVASCRIPT</h4>
									<h4 class="resume-skills-cat font-weight-bold">JAVA</h4>
									<h4 class="resume-skills-cat font-weight-bold">PYTHON</h4>
									<h4 class="resume-skills-cat font-weight-bold">C#</h4>
									<h4 class="resume-skills-cat font-weight-bold">C++</h4>
						...
						<section class="resume-section education-section mb-5">
							...
							<div class="resume-section-content">
								<ul class="list-unstyled">
									<li class="mb-2">
										<div class="resume-degree font-weight-bold">Đại học KT-CN Cần Thơ</div>
										<div class="resume-degree-org">Tốt nghiệp loại Giỏi, điểm trung bình 8.4</div>
							...
							<div class="resume-section-content">
								<ul class="list-unstyled resume-awards-list">
									<li class="mb-2 pl-4 position-relative">
										...
										<div class="resume-award-name">Học bổng học tập (loại giỏi)</div>
										<div class="resume-award-desc">Năm 2016</div>
									</li>
									<li class="mb-0 pl-4 position-relative">
										<svg class="svg-inline--fa fa-trophy fa-w-18 resume-award-icon position-absolute" data-fa-transform="shrink-2" aria-hidden="true" data-prefix="fas" data-icon="trophy" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="" style="transform-origin: 0.5625em 0.5em;"><g transform="translate(288 256)"><g transform="translate(0, 0)  scale(0.875, 0.875)  rotate(0 0 0)"><path fill="currentColor" d="M552 64H448V24c0-13.3-10.7-24-24-24H152c-13.3 0-24 10.7-24 24v40H24C10.7 64 0 74.7 0 88v56c0 35.7 22.5 72.4 61.9 100.7 31.5 22.7 69.8 37.1 110 41.7C203.3 338.5 240 360 240 360v72h-48c-35.3 0-64 20.7-64 56v12c0 6.6 5.4 12 12 12h296c6.6 0 12-5.4 12-12v-12c0-35.3-28.7-56-64-56h-48v-72s36.7-21.5 68.1-73.6c40.3-4.6 78.6-19 110-41.7 39.3-28.3 61.9-65 61.9-100.7V88c0-13.3-10.7-24-24-24zM99.3 192.8C74.9 175.2 64 155.6 64 144v-16h64.2c1 32.6 5.8 61.2 12.8 86.2-15.1-5.2-29.2-12.4-41.7-21.4zM512 144c0 16.1-17.7 36.1-35.3 48.8-12.5 9-26.7 16.2-41.8 21.4 7-25 11.8-53.6 12.8-86.2H512v16z" transform="translate(-288 -256)"></path></g></g></svg><!-- <i class="resume-award-icon fas fa-trophy position-absolute" data-fa-transform="shrink-2"></i> -->
										<div class="resume-award-name">Học bổng học tập (loại giỏi)</div>
										<div class="resume-award-desc">Năm 2017</div>
									</li>
								</ul>
							</div>
						...
						<section class="resume-section language-section mb-5">
							...
							<div class="resume-section-content">
								<ul class="list-unstyled resume-lang-list">
									<li class="mb-2"><span class="resume-lang-name font-weight-bold">Chứng chỉ tin học căn bản</span> <small class="text-muted font-weight-normal">(2016)</small></li>
								</ul>
							</div>
						...
						<section class="resume-section interests-section mb-5">
							...
							<div class="resume-section-content">
								<ul class="list-unstyled">
									<li class="mb-1">Bơi lội</li>
									<li class="mb-1">Bóng đá</li>
									<li class="mb-1">Cầu lông</li>
									<li class="mb-1">Nghe nhạc</li>
									<li class="mb-1">Shopping</li>
									<li class="mb-1">Đọc sách</li>
								</ul>
							</div>
						</section><!--//interests-section-->
					</div>
