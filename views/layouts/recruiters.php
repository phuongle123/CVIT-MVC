		...
		<div class="container">
			<div class="row">
				<div class="col-md-2 col-12">
					<a href="index-ntd.html" class="logo-main"><img src="../../public/img/logo.png" alt="" class=""></a>
				</div>
				<div class="col-md-7">
...
<!-- 						<a class="info">
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu shadow" aria-labelledby="dropdowntk">
								<a class="dropdown-item" href="thongtinntd-ntd.html">Thông tin nhà tuyển dụng</a>
	...
	<header>
		<div class="container">
			<div class="row">
				<div class="col-md-2 col-12">
					<a href="index_ntd.php" class="logo-main"><img src="../../public/img/logo.png" alt="" class=""></a>
				</div>
				<div class="col-md-7">
					<form class="example form-search" action="action_page.php">
						<input type="text" placeholder="Tìm kiếm.." name="search">
				...
				<div class="col-md-12">
					<div class="collapse navbar-collapse" id="navbarSupportedContent1">
						<ul class="navbar-nav mr-auto">
							<li class="nav-item">
								<a class="nav-link home-link" href="index-ntd.html"><i class="fa fa-home"></i>TRANG CHỦ</a>
							</li>
							<li class="nav-item cn">
								<a class="nav-link" href="dscvpapply.html" role="button">DANH SÁCH CV APPLY</a>
							</li>
						</ul> <!-- end ul -->
					</div>
